...
import com.github.washappy.screen.recources.OneMinutePanelResources;
...
public class OneMinutePanel extends AbstractPanel{

    private final OneMinutePanelResources resources = new OneMinutePanelResources();
    private final JButton backButton = new JButton(resources.backButtonBasic);

    public OneMinutePanel(){
